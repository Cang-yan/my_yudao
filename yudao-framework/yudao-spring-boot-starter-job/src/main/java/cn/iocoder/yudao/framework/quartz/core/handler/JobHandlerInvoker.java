...
public class JobHandlerInvoker extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext executionContext) throws JobExecutionException {
        // 第一步，获得 Job 数据
        String jobId =String.valueOf(executionContext.getMergedJobDataMap().getLong(JobDataKeyEnum.JOB_ID.name()));
    ...
    private void updateJobLogResultAsync(String jobLogId, Date startTime, String data, Throwable exception,
