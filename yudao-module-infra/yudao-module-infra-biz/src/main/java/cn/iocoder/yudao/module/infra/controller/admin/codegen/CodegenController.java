...
public class CodegenController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "dataSourceConfigId", value = "数据源配置的编号", required = true, example = "1", dataTypeClass = String.class),
    ...
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = String.class)
    @PreAuthorize("@ss.hasPermission('infra:codegen:query')")
    public CommonResult<CodegenDetailRespVO> getCodegenDetail(@RequestParam("tableId") String tableId) {
    ...
    public CommonResult<List<String>> createCodegenList(@Valid @RequestBody CodegenCreateListReqVO reqVO) {
    ...
    @ApiImplicitParam(name = "tableId", value = "表编号", required = true, example = "1024", dataTypeClass = String.class)
    @PreAuthorize("@ss.hasPermission('infra:codegen:update')")
    public CommonResult<Boolean> syncCodegenFromDB(@RequestParam("tableId") String tableId) {
    ...
    public CommonResult<Boolean> deleteCodegen(@RequestParam("tableId") String tableId) {
    ...
    public CommonResult<List<CodegenPreviewRespVO>> previewCodegen(@RequestParam("tableId") String tableId) {
