...
public class ConfigController {
    ...
    public CommonResult<String> createConfig(@Valid @RequestBody ConfigCreateReqVO reqVO) {
    ...
    public CommonResult<Boolean> deleteConfig(@RequestParam("id") String id) {
    ...
    public CommonResult<ConfigRespVO> getConfig(@RequestParam("id") String id) {
