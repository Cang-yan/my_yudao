...
public class DataSourceConfigController {
    ...
    public CommonResult<String> createDataSourceConfig(@Valid @RequestBody DataSourceConfigCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteDataSourceConfig(@RequestParam("id") String id) {
    ...
    public CommonResult<DataSourceConfigRespVO> getDataSourceConfig(@RequestParam("id")  String id) {
