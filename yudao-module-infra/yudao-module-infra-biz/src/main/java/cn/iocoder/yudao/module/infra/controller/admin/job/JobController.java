...
public class JobController {
    ...
    @PreAuthorize("@ss.hasPermission('infra:job:update')")
    public CommonResult<Boolean> updateJobStatus(@RequestParam(value = "id")  String id, @RequestParam("status") Integer status)
            throws SchedulerException {
    ...
    public CommonResult<Boolean> deleteJob(@RequestParam("id")  String id)
            throws SchedulerException {
    ...
    public CommonResult<Boolean> triggerJob(@RequestParam("id")  String id) throws SchedulerException {
    ...
    public CommonResult<JobRespVO> getJob(@RequestParam("id")  String id) {
    ...
    @PreAuthorize("@ss.hasPermission('infra:job:query')")
    public CommonResult<List<JobRespVO>> getJobList(@RequestParam("ids") Collection< String> ids) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass =  String.class),
            @ApiImplicitParam(name = "count", value = "数量", example = "5", dataTypeClass =  Integer.class)
    })
    @PreAuthorize("@ss.hasPermission('infra:job:query')")
    public CommonResult<List<Date>> getJobNextTimes(@RequestParam("id")  String id,
