...
public class JobLogController {
    ...
    public CommonResult<JobLogRespVO> getJobLog(@RequestParam("id")  String id) {
    ...
    @PreAuthorize("@ss.hasPermission('infra:job:query')")
    public CommonResult<List<JobLogRespVO>> getJobLogList(@RequestParam("ids") Collection< String> ids) {
