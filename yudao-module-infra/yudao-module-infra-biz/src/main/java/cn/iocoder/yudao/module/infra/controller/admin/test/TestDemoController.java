...
public class TestDemoController {
    ...
    public CommonResult< String> createTestDemo(@Valid @RequestBody TestDemoCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteTestDemo(@RequestParam("id")  String id) {
    ...
    public CommonResult<TestDemoRespVO> getTestDemo(@RequestParam("id")  String id) {
    ...
    @PreAuthorize("@ss.hasPermission('infra:test-demo:query')")
    public CommonResult<List<TestDemoRespVO>> getTestDemoList(@RequestParam("ids") Collection< String> ids) {
