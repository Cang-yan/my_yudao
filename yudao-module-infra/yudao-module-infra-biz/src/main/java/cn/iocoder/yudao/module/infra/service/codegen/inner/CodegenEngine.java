...
public class CodegenEngine {
    ...
    private static final Map<String, String> TEMPLATES = MapUtil.<String, String>builder(new LinkedHashMap<>()) // 有序
            ...
            .put(vueTemplatePath("views/index.vue"),
                    vueFilePath("codegen/views/${table.moduleName}/${classNameVar}/index.vue"))
            .put(vueTemplatePath("api/api.js"),
                    vueFilePath("codegen/api/${table.moduleName}/${classNameVar}.js"))
            // Vue3
            ...
            .put("codegen/sql/h2.vm", "sql/h2${table.className}.sql")
            .build();
