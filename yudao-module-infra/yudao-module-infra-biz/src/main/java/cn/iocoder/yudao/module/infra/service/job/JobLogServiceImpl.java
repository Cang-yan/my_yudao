...
public class JobLogServiceImpl implements JobLogService {
    ...
    @Override
    public String createJobLog(String jobId, Date beginTime, String jobHandlerName, String jobHandlerParam, Integer executeIndex) {
    ...
    @Override
    @Async
    public void updateJobLogResultAsync(String logId, Date endTime, Integer duration, boolean success, String result) {
        try {
    ...
    @Override
    public List<JobLogDO> getJobLogList(Collection<String> ids) {
