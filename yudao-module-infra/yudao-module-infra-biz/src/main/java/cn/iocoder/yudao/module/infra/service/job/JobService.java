...
public interface JobService {
     ...
     * @param status 状态
     */
    void updateJobStatus(String id, Integer status) throws SchedulerException;
     ...
     * @param id 任务编号
     */
    void triggerJob(String id) throws SchedulerException;
     ...
     * @return 定时任务列表
     */
    List<JobDO> getJobList(Collection<String> ids);
