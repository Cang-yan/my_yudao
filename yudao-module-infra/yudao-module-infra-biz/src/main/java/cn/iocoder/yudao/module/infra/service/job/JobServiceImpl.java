...
public class JobServiceImpl implements JobService {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateJobStatus(String id, Integer status) throws SchedulerException {
        // 校验 status
    ...
    private JobDO validateJobExists(String id) {
    ...
    @Override
    public List<JobDO> getJobList(Collection<String> ids) {
