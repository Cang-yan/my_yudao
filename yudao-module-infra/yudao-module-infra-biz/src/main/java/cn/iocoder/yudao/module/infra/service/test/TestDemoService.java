...
public interface TestDemoService {
     ...
     * @return 编号
     */
    String createTestDemo(@Valid TestDemoCreateReqVO createReqVO);
     ...
     * @return 字典类型
     */
    TestDemoDO getTestDemo(String id);
     ...
     * @return 字典类型列表
     */
    List<TestDemoDO> getTestDemoList(Collection<String> ids);
