...
public class TestDemoServiceImpl implements TestDemoService {
    ...
    @Override
    public String createTestDemo(TestDemoCreateReqVO createReqVO) {
        // 插入
    ...
    public void deleteTestDemo(String id) {
        // 校验存在
    ...
    private void validateTestDemoExists(String id) {
    ...
    public TestDemoDO getTestDemo(String id) {
        return testDemoMapper.selectById(id);
    }

    @Override
    public List<TestDemoDO> getTestDemoList(Collection<String> ids) {
