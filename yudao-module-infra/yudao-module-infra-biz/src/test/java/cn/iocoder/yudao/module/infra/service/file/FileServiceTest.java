...
public class FileServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateFile_success() throws Exception {
        ...
        when(client.getId()).thenReturn("10");
        String name = "单测文件名";
        // 调用
        ...
        assertEquals("10", file.getConfigId());
    ...
    public void testDeleteFile_success() throws Exception {
        // mock 数据
        FileDO dbFile = randomPojo(FileDO.class, o -> o.setConfigId("10").setPath("tudou.jpg"));
        fileMapper.insert(dbFile);// @Sql: 先插入出一条存在的数据
        // mock Master 文件客户端
        FileClient client = mock(FileClient.class);
        when(fileConfigService.getFileClient(eq("10"))).thenReturn(client);
        // 准备参数
