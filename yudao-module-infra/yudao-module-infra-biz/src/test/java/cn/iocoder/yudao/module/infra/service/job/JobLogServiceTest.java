...
public class JobLogServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateJobLog_success() {
        ...
        // 调用
        String jobLogId = jobLogService.createJobLog(reqVO.getJobId(), reqVO.getBeginTime(), reqVO.getHandlerName(), reqVO.getHandlerParam(), reqVO.getExecuteIndex());
        // 断言
    ...
    public void testGetJobPage_success() {
        ...
        jobLogMapper.insert(dbJobLog);
        // 测试 jobId 不匹配
        jobLogMapper.insert(ObjectUtils.cloneIgnoreId(dbJobLog, o -> o.setJobId(randomLongId().toString())));
        // 测试 handlerName 不匹配
