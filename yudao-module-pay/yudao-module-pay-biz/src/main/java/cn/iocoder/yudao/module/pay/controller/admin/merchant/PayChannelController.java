...
public class PayChannelController {
    ...
    public CommonResult<String> createChannel(@Valid @RequestBody PayChannelCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteChannel(@RequestParam("id") String id) {
    ...
    public CommonResult<PayChannelRespVO> getChannel(@RequestParam("id") String id) {
    ...
    @PreAuthorize("@ss.hasPermission('pay:channel:query')")
    public CommonResult<List<PayChannelRespVO>> getChannelList(@RequestParam("ids") Collection<String> ids) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "merchantId", value = "商户编号",
                    required = true, example = "1", dataTypeClass = String.class),
    ...
    public CommonResult<PayChannelRespVO> getChannel(
            @RequestParam String merchantId, @RequestParam String appId, @RequestParam String code) {
        // 獲取渠道
