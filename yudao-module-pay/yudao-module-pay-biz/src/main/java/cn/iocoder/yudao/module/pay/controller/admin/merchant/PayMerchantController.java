...
public class PayMerchantController {
    ...
    public CommonResult<String> createMerchant(@Valid @RequestBody PayMerchantCreateReqVO createReqVO) {
    ...
    public CommonResult<PayMerchantRespVO> getMerchant(@RequestParam("id") String id) {
    ...
    @PreAuthorize("@ss.hasPermission('pay:merchant:query')")
    public CommonResult<List<PayMerchantRespVO>> getMerchantList(@RequestParam("ids") Collection<String> ids) {
