...
public interface PayAppService {
     ...
     * @return 编号
     */
    String createApp(@Valid PayAppCreateReqVO createReqVO);
     ...
     * @return 支付应用信息列表
     */
    List<PayAppDO> getAppList(Collection<String> ids);
     ...
     */
    void updateAppStatus(String id, Integer status);
     ...
     * @return 商户 Map
     */
    default Map<String, PayAppDO> getAppMap(Collection<String> appIdList) {
     ...
     * @return 应用信息
     */
    PayAppDO validPayApp(String id);
