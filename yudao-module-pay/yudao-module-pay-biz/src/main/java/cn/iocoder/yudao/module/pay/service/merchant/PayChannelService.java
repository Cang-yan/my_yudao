...
public interface PayChannelService {
     ...
     * @return 编号
     */
    String createChannel(@Valid PayChannelCreateReqVO createReqVO);
     ...
     * @return 支付渠道
     */
    PayChannelDO getChannel(String id);
     ...
     * 列表
     */
    List<PayChannelDO> getChannelList(Collection<String> ids);
     ...
     * @return 支付渠道列表
     */
    List<PayChannelDO> getChannelListByAppIds(Collection<String> appIds);
     ...
     * @return 数量
     */
    Integer getChannelCountByConditions(String merchantId, String appid, String code);
     ...
     * @return 数量
     */
    PayChannelDO getChannelByConditions(String merchantId, String appid, String code);
     ...
     * @return 渠道信息
     */
    PayChannelDO validPayChannel(String id);
     ...
     * @return 渠道信息
     */
    PayChannelDO validPayChannel(String appId, String code);
