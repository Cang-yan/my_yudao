...
public interface PayMerchantService {
     ...
     * @return 编号
     */
    String createMerchant(@Valid PayMerchantCreateReqVO createReqVO);
     ...
     * @return 支付商户信息
     */
    PayMerchantDO getMerchant(String id);
     ...
     * @return 支付商户信息列表
     */
    List<PayMerchantDO> getMerchantList(Collection<String> ids);
     ...
     * @param status 状态
     */
    void updateMerchantStatus(String id, Integer status);
     ...
     * @return 商户 Map
     */
    default Map<String, PayMerchantDO> getMerchantMap(Collection<String> merchantIds) {
