...
public class PayMerchantServiceImpl implements PayMerchantService {
    ...
    @Override
    public String createMerchant(PayMerchantCreateReqVO createReqVO) {
        // 插入
    ...
    @Override
    public PayMerchantDO getMerchant(String id) {
        return merchantMapper.selectById(id);
    }

    @Override
    public List<PayMerchantDO> getMerchantList(Collection<String> ids) {
    ...
    @Override
    public void updateMerchantStatus(String id, Integer status) {
        // 校验商户存在
    ...
    @VisibleForTesting
    public void checkMerchantExists(String id) {
        if (id == null) {
            return;
        }
