...
public interface PayOrderExtensionService {
     ...
     * @return 支付订单
     */
    PayOrderExtensionDO getOrderExtension(String id);
     ...
     * 列表
     */
    List<PayOrderExtensionDO> getOrderExtensionList(Collection<String> ids);
     ...
     * @return 订单扩展 map 集合
     */
    default Map<String, PayOrderExtensionDO> getOrderExtensionMap(Collection<String> successExtensionIdList) {
