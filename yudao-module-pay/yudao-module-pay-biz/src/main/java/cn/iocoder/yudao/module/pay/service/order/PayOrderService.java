...
public interface PayOrderService {
     ...
     * @return 只包含商品名称的订单集合
     */
    List<PayOrderDO> getOrderSubjectList(Collection<String> idList);
     ...
     * @return 订单商品 map 集合
     */
    default Map<String, PayOrderDO> getOrderSubjectMap(Collection<String> idList) {
     ...
     * @return 支付单编号
     */
    String createPayOrder(@Valid PayOrderCreateReqDTO reqDTO);
     ...
     */
    void notifyPayOrder(String channelId,  PayNotifyDataDTO notifyData) throws Exception;
