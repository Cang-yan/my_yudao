...
public class PayOrderServiceTest extends BaseDbUnitTest {
    ...
    public void testGetOrderPage() {
        ...
        // 测试 merchantId 不匹配
        orderMapper.insert(cloneIgnoreId(dbOrder, o -> o.setMerchantId("2")));
        // 测试 appId 不匹配
        orderMapper.insert(cloneIgnoreId(dbOrder, o -> o.setAppId("2")));
        // 测试 channelId 不匹配
        orderMapper.insert(cloneIgnoreId(dbOrder, o -> o.setChannelId("2")));
        // 测试 channelCode 不匹配
