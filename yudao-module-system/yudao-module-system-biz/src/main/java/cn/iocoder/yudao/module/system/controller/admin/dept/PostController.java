...
public class PostController {
    ...
    public CommonResult<String> createPost(@Valid @RequestBody PostCreateReqVO reqVO) {
    ...
    @ApiOperation("获得岗位信息")
    @ApiImplicitParam(name = "id", value = "岗位编号", required = true, example = "1024", dataTypeClass = String.class)
    @PreAuthorize("@ss.hasPermission('system:post:query')")
    public CommonResult<PostRespVO> getPost(@RequestParam("id") String id) {
