...
public class DictDataController {
    ...
    public CommonResult<String> createDictData(@Valid @RequestBody DictDataCreateReqVO reqVO) {
    ...
    public CommonResult<Boolean> deleteDictData(String id) {
    ...
    @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = String.class)
    @PreAuthorize("@ss.hasPermission('system:dict:query')")
    public CommonResult<DictDataRespVO> getDictData(@RequestParam("id") String id) {
