...
public class DictTypeController {
    ...
    public CommonResult<String> createDictType(@Valid @RequestBody DictTypeCreateReqVO reqVO) {
    ...
    @PreAuthorize("@ss.hasPermission('system:dict:query')")
    public CommonResult<DictTypeRespVO> getDictType(@RequestParam("id") String id) {
