...
public class ErrorCodeController {
    ...
    public CommonResult<String> createErrorCode(@Valid @RequestBody ErrorCodeCreateReqVO createReqVO) {
    ...
    public CommonResult<ErrorCodeRespVO> getErrorCode(@RequestParam("id") String id) {
