...
public class NoticeController {
    ...
    public CommonResult<String> createNotice(@Valid @RequestBody NoticeCreateReqVO reqVO) {
        String noticeId = noticeService.createNotice(reqVO);
    ...
    public CommonResult<Boolean> deleteNotice(@RequestParam("id") String id) {
    ...
    @ApiImplicitParam(name = "id", value = "编号", required = true, example = "1024", dataTypeClass = String.class)
    @PreAuthorize("@ss.hasPermission('system:notice:query')")
    public CommonResult<NoticeRespVO> getNotice(@RequestParam("id") String id) {
