...
public class OAuth2ClientController {
    ...
    public CommonResult<String> createOAuth2Client(@Valid @RequestBody OAuth2ClientCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteOAuth2Client(@RequestParam("id") String id) {
    ...
    public CommonResult<OAuth2ClientRespVO> getOAuth2Client(@RequestParam("id") String id) {
