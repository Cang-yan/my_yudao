...
public class SensitiveWordController {
    ...
    public CommonResult<String> createSensitiveWord(@Valid @RequestBody SensitiveWordCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteSensitiveWord(@RequestParam("id") String id) {
    ...
    public CommonResult<SensitiveWordRespVO> getSensitiveWord(@RequestParam("id") String id) {
