...
public class SmsChannelController {
    ...
    public CommonResult<String> createSmsChannel(@Valid @RequestBody SmsChannelCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteSmsChannel(@RequestParam("id") String id) {
    ...
    public CommonResult<SmsChannelRespVO> getSmsChannel(@RequestParam("id") String id) {
