...
public class SmsTemplateController {
    ...
    public CommonResult<String> createSmsTemplate(@Valid @RequestBody SmsTemplateCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteSmsTemplate(@RequestParam("id") String id) {
    ...
    public CommonResult<SmsTemplateRespVO> getSmsTemplate(@RequestParam("id") String id) {
    ...
    public CommonResult<String> sendSms(@Valid @RequestBody SmsTemplateSendReqVO sendReqVO) {
