...
public class TenantPackageController {
    ...
    public CommonResult<String> createTenantPackage(@Valid @RequestBody TenantPackageCreateReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteTenantPackage(@RequestParam("id") String id) {
    ...
    public CommonResult<TenantPackageRespVO> getTenantPackage(@RequestParam("id") String id) {
