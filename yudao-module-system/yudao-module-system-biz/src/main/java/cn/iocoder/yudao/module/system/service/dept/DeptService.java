...
public interface DeptService {
     ...
     * @return 子部门列表
     */
    List<DeptDO> getDeptsByParentIdFromCache(String parentId, boolean recursive);
     ...
     * @return 部门信息数组
     */
    List<DeptDO> getDepts(Collection<String> ids);
     ...
     * @return 部门列表
     */
    List<DeptDO> getSimpleDepts(Collection<String> ids);
