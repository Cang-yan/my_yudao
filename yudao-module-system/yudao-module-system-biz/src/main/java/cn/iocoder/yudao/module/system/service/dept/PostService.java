...
public interface PostService {
     ...
     * @return 部门列表
     */
    default List<PostDO> getPosts(@Nullable Collection<String> ids) {
     ...
     * @return 部门列表
     */
    List<PostDO> getPosts(@Nullable Collection<String> ids, @Nullable Collection<Integer> statuses);
     ...
     * @param ids 岗位编号数组
     */
    void validPosts(Collection<String> ids);
