...
public class SensitiveWordServiceImpl implements SensitiveWordService {
    ...
    @Override
    public String createSensitiveWord(SensitiveWordCreateReqVO createReqVO) {
        // 校验唯一性
    ...
    private void checkSensitiveWordNameUnique(String id, String name) {
    ...
    private void checkSensitiveWordExists(String id) {
    ...
    @Override
    public SensitiveWordDO getSensitiveWord(String id) {
