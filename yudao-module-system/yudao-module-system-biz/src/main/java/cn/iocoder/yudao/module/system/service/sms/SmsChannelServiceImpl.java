...
public class SmsChannelServiceImpl implements SmsChannelService {
    ...
    @Override
    public String createSmsChannel(SmsChannelCreateReqVO createReqVO) {
        // 插入
    ...
    @Override
    public void deleteSmsChannel(String id) {
        // 校验存在
    ...
    private void validateSmsChannelExists(String id) {
    ...
    @Override
    public SmsChannelDO getSmsChannel(String id) {
        return smsChannelMapper.selectById(id);
    }

    @Override
    public List<SmsChannelDO> getSmsChannelList(Collection<String> ids) {
