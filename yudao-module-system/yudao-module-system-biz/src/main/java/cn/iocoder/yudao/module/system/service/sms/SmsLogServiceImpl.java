...
public class SmsLogServiceImpl implements SmsLogService {
    ...
    @Override
    public String createSmsLog(String mobile, String userId, Integer userType, Boolean isSend,
    ...
    @Override
    public void updateSmsSendResult(String id, Integer sendCode, String sendMsg,
    ...
    @Override
    public void updateSmsReceiveResult(String id, Boolean success, Date receiveTime,
