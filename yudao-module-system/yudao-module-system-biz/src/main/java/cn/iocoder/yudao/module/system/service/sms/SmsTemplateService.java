...
public interface SmsTemplateService {
     ...
     * @return 编号
     */
    String createSmsTemplate(@Valid SmsTemplateCreateReqVO createReqVO);
     ...
     * @return 短信模板
     */
    SmsTemplateDO getSmsTemplate(String id);
     ...
     * @return 短信模板列表
     */
    List<SmsTemplateDO> getSmsTemplateList(Collection<String> ids);
