...
public class SmsTemplateServiceImpl implements SmsTemplateService {
    ...
    @Override
    public String createSmsTemplate(SmsTemplateCreateReqVO createReqVO) {
        // 校验短信渠道
    ...
    @Override
    public SmsTemplateDO getSmsTemplate(String id) {
        return smsTemplateMapper.selectById(id);
    }

    @Override
    public List<SmsTemplateDO> getSmsTemplateList(Collection<String> ids) {
    ...
    @VisibleForTesting
    public SmsChannelDO checkSmsChannel(String channelId) {
    ...
    @VisibleForTesting
    public void checkSmsTemplateCodeDuplicate(String id, String code) {
     ...
     */
    @VisibleForTesting
    public void checkApiTemplate(String channelId, String apiTemplateId) {
        // 获得短信模板
