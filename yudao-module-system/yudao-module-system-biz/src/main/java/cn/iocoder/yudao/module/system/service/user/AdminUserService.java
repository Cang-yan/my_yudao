...
public interface AdminUserService extends IService<AdminUserDO> {
     ...
     * @return 用户数组
     */
    List<AdminUserDO> getUsersByDeptIds(Collection<String> deptIds);
     ...
     * @return 用户数组
     */
    List<AdminUserDO> getUsersByPostIds(Collection<String> postIds);
     ...
     * @return 用户列表
     */
    List<AdminUserDO> getUsers(Collection<String> ids);
     ...
     * @return 用户 Map
     */
    default Map<String, AdminUserDO> getUserMap(Collection<String> ids) {
