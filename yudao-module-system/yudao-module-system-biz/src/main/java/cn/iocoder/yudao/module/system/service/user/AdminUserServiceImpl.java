...
public class AdminUserServiceImpl extends ServiceImpl<AdminUserMapper,AdminUserDO> implements AdminUserService {
    ...
    private void updateUserPost(UserUpdateReqVO reqVO, AdminUserDO updateObj) {
        ...
        Set<String> dbPostIds = convertSet(userPostMapper.selectListByUserId(userId), UserPostDO::getPostId);
        // 计算新增和删除的岗位编号
    ...
    @Override
    public List<AdminUserDO> getUsersByDeptIds(Collection<String> deptIds) {
    ...
    @Override
    public List<AdminUserDO> getUsersByPostIds(Collection<String> postIds) {
    ...
    @Override
    public List<AdminUserDO> getUsers(Collection<String> ids) {
    ...
    private Set<String> getDeptCondition(String deptId) {
        ...
        Set<String> deptIds = convertSet(deptService.getDeptsByParentIdFromCache(
