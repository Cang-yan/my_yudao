...
public class DeptServiceTest extends BaseDbUnitTest {
    ...
    void testInitLocalCache() {
        ...
        // 断言 deptCache 缓存
        Map<String, DeptDO> deptCache = (Map<String, DeptDO>) getFieldValue(deptService, "deptCache");
        ...
        Multimap<String, DeptDO> parentDeptCache = (Multimap<String, DeptDO>) getFieldValue(deptService, "parentDeptCache");
