...
public class DictDataServiceTest extends BaseDbUnitTest {
    ...
    public void testCheckDictDataExists_notExists() {
        assertServiceException(() -> dictDataService.checkDictDataExists(randomLongId().toString()), DICT_DATA_NOT_EXISTS);
    }
    ...
    public void testCheckDictDataValueUnique_success() {
        // 调用，成功
        dictDataService.checkDictDataValueUnique(randomLongId().toString(), randomString(), randomString());
    }
