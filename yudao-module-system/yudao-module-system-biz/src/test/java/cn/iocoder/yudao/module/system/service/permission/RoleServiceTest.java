...
public class RoleServiceTest extends BaseDbUnitTest {
    ...
    public void testInitLocalCache() {
        ...
        // 断言 roleCache 缓存
        Map<String, RoleDO> roleCache = roleService.getRoleCache();
    ...
    public void testUpdateRoleDataScope_success() {
        ...
        //调用
        Set<String> deptIdSet = Arrays.asList("1", "2", "3", "4", "5").stream().collect(Collectors.toSet());
        ...
        Set<String> newDeptIdSet = newRoleDO.getDataScopeDeptIds();
    ...
    public void testCheckUpdateRole_roleIdNotExist() {
        assertServiceException(() -> roleService.checkUpdateRole(randomLongId().toString()), ROLE_NOT_EXISTS);
    }
    ...
    private RoleDO createRoleDO(String id, String name, RoleTypeEnum typeEnum, DataScopeEnum scopeEnum, Integer status, String code) {
