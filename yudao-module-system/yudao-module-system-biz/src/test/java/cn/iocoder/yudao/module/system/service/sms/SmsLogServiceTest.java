...
public class SmsLogServiceTest extends BaseDbUnitTest {
    ...
    public void testGetSmsLogPage() {
       ...
       // 测试 channelId 不匹配
       smsLogMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsLog, o -> o.setChannelId("2")));
       // 测试 templateId 不匹配
       smsLogMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsLog, o -> o.setTemplateId("20")));
       // 测试 mobile 不匹配
    ...
    public void testCreateSmsLog() {
        ...
        // 调用
        String logId = smsLogService.createSmsLog(mobile, userId, userType, isSend,
