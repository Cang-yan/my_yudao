...
public class SmsSendServiceTest extends BaseMockitoUnitTest {
    ...
    public void testSendSingleSms_successWhenSmsTemplateEnable() {
        ...
        String smsLogId = randomLongId().toString();
        ...
        // 调用
        String resultSmsLogId = smsService.sendSingleSms(mobile, userId, userType, templateCode, templateParams);
        // 断言
    ...
    public void testSendSingleSms_successWhenSmsTemplateDisable() {
        ...
        assertEquals(smsLogId, resultSmsLogId);
        // 断言调用
        verify(smsProducer, times(0)).sendSmsSendMessage(String.valueOf(anyLong()), anyString(),
                String.valueOf(anyLong()), any(), anyList());
    }
