  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="年代，按照年月日划分吧" prop="date">
        <el-date-picker v-model="queryParams.date" style="width: 240px" value-format="yyyy-MM-dd HH:mm:ss" type="daterange"
                        range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :default-time="['00:00:00', '23:59:59']" />
      </el-form-item>
      ...
      <el-form-item label="用户名字" prop="userName">
        <el-input v-model="queryParams.userName" placeholder="请输入用户名字" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['identity:archives:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="年代，按照年月日划分吧" align="center" prop="date" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.date) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="档案号" align="center" prop="refNum" />
      <el-table-column label="0未标注 1有租户标注 2有标注员 3两个都有" align="center" prop="status" />
      <el-table-column label="用户id" align="center" prop="userId" />
      <el-table-column label="用户名字" align="center" prop="userName" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['identity:archives:update']">修改</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['identity:archives:delete']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="年代，按照年月日划分吧" prop="date">
          <el-date-picker clearable v-model="form.date" type="date" value-format="timestamp" placeholder="选择年代，按照年月日划分吧" />
        </el-form-item>
        <el-form-item label="档案号" prop="refNum">
...
<script>
import { createArchives, updateArchives, deleteArchives, getArchives, getArchivesPage, exportArchivesExcel } from "@/api/identity/archives";
  ...
  methods: {
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        ...
        // 添加的提交
        createArchives(this.form).then(response => {
