<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="api资源id" prop="apiResourcesId">
        <el-input v-model="queryParams.apiResourcesId" placeholder="请输入api资源id" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                   v-hasPermi="['resource:apicount:create']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['resource:apicount:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="api资源id" align="center" prop="apiResourcesId" />
      <el-table-column label="剩余调用次数" align="center" prop="count" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" v-dialogDrag append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="api资源id" prop="apiResourcesId">
          <el-input v-model="form.apiResourcesId" placeholder="请输入api资源id" />
        </el-form-item>
        <el-form-item label="剩余调用次数" prop="count">
...
<script>
import { createApicount, updateApicount, deleteApicount, getApicount, getApicountPage, exportApicountExcel } from "@/api/resource/apicount";
    ...
    submitForm() {
      this.$refs["form"].validate(valid => {
        ...
        if (this.form.id != null) {
          updateApicount(this.form).then(response => {
