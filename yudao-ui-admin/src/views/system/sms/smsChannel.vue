      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="130px">
        ...
        <el-form-item label="渠道编码" prop="code">
          <el-select v-model="form.code" placeholder="请选择渠道编码" clearable>
            <el-option v-for="dict in this.getDictDatas(DICT_TYPE.SYSTEM_SMS_CHANNEL_CODE)" :key="dict.value"
...
<script>
import {
  createSmsChannel, updateSmsChannel, deleteSmsChannel, getSmsChannel, getSmsChannelPage,
